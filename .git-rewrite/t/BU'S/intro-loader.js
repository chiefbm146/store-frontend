...
const introLoader = {
    ...
    MIN_DISPLAY_TIME: 5000, // 5 seconds in milliseconds
        ...
        if (!document.getElementById(styleId)) {
            ...
            style.textContent = `
                ...
                #intro-loader-overlay {
                    background: var(--bg-window, #F5F1E8); /* Match app's background */
                    position: fixed;
                    inset: 0;
                    display: flex;
                    align-items: center;
                ...
                #intro-loader-overlay .loader-inner .loader-logo {
                    ...
                    align-items: center;
                    justify-content: center;
                    animation: intro-color-change 2s infinite ease-in-out;
                    z-index: 999;
                }
                ...
                #intro-loader-overlay .loader-inner .box {
                    ...
                    animation: intro-ripple 2s infinite ease-in-out;
                }
     ...
     */
    hide() {
        return new Promise(resolve => { // <--- MODIFIED to return a Promise
            if (!this.isActive) {
            ...
            if (remainingTime > 0) {
                console.log(`[IntroLoader] Delaying hide by ${remainingTime}ms to enforce minimum ${this.MIN_DISPLAY_TIME}ms display time.`);
                setTimeout(performHideWithDelay, remainingTime);
            } else {
                console.log('[IntroLoader] Minimum display time reached, hiding immediately.');
